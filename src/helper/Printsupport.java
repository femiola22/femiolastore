...
import controllers.posPageController;
 ...
 */
		...
		public class Printsupport {
			...
			static JTable itemsTable;
	         ...
	         public  static String title[] = new String[] {"SN","Item","Quan.","Price"};
	...
	public static class MyPrintable implements Printable {
	 @Override
	  public int print(Graphics graphics, PageFormat pageFormat, 
		                ...
		                Font font = new Font("Monospace",Font.BOLD,7);       
		                g2d.setFont(font);
		        	...
		        	/*
	                         ...
	                         */
	                                    @SuppressWarnings("unused")
										int x=65 ;                                        //print start at 100 on x axies
	                                    @SuppressWarnings("unused")
										int y=2;                                          //print start at 10 on y axies
	                                    int imagewidth=100;
	                                    int imageheight=50;
	                          BufferedImage read1 = ImageIO.read(getClass().getResource("/javaResized.png"));
	                          @SuppressWarnings("unused")
							Image read = read1.getScaledInstance(imagewidth, imageheight, Image.SCALE_SMOOTH);
//	                          g2d.drawImage(read,20,y,imagewidth,imageheight,null);         //draw image
//	                          g2d.drawLine(1, y+60, 180, y+60);                          //draw line
//	                          g2d.drawLine(1, y, 180, y); 
	                                 } catch (IOException e) {
		        			e.printStackTrace();
		        		}
	      		try{
...
//	                    int y=80;
	                    int y=10;
		              g2d.drawString("LET US VARIETY STORE", 0,y);  
		              g2d.drawString("08066613611, 07065368634", 10,y+10);                 //shift a line by adding 10 to y value
		              g2d.drawString(now(), 10, y+20);                                //print date
		              g2d.drawString("Cashier : "+ loginPageController.getName(), 10, y+30);
//		              g2d.drawString("Cashier : Staff 1", 10, y+30); 
		        		
		              /*Draw Colums*/
	                      g2d.drawLine(1, y+40, 180, y+40);
	                      g2d.drawString(title[0], 1 ,y+50);
	                      g2d.drawString(title[1], 15 ,y+50);
	                      g2d.drawString(title[3], 85 ,y+50);
	                      g2d.drawString(title[2], 117 ,y+50);
	                      g2d.drawLine(1, y+55, 180, y+55);
		              
//		              g2d.drawLine(1, y+40, 180, y+40);
//                      g2d.drawString(title[0], 1 ,y+50);
//                      g2d.drawString(title[1], 15 ,y+50);
//                      g2d.drawString(title[2], 120 ,y+50);
...
//		                	String itemid = mod.getValueAt(i, 0).toString();
		                	...
		                	String shortItemName = itemname.substring(0, Math.min(itemname.length(), 15))+"...";
	                        String price = mod.getValueAt(i, 2).toString();
	                        String quantity = mod.getValueAt(i, 3).toString();
		                	
		                	cH = (y+70) + (10*i);                             //shifting drawing line
		                	font = new Font("Monospace",Font.PLAIN,8);                  //changed font size
			                g2d.setFont(font);
		                	g2d.drawString(Integer.toString(i+1), 1, cH);
		                	if (itemname.length()>15){
		                	g2d.drawString(shortItemName,15, cH);
		                	}else{
		                		g2d.drawString(itemname,15, cH);
		                	}		                	
//		                	g2d.drawString(price , 125, cH);
//		                	g2d.drawString("x" , 140, cH);
		                	g2d.drawString(quantity , 85, cH);
		                	g2d.drawString("*" , 114, cH);
	                        g2d.drawString(price , 121, cH);
		                }
		                /*Footer*/
		                font = new Font("Monospace",Font.BOLD,8);                  //changed font size
		                g2d.setFont(font);
	                        g2d.drawString("Total: "+ posPageController.getTotalPrice()+".00", 30, cH+20);
	                        
	                        font = new Font("Tempus Sans ITC",Font.BOLD,9);
	                        g2d.setFont(font);
	                        g2d.drawString("Thank You...",10, cH+40);
